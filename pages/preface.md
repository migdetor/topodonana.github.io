...
**[EN]**
The idea for this map did not begin as something premeditated; it simply emerged, like an <abbr title="A natural, permanent freshwater spring that surfaces through the clayey soils of the marsh.">ojo</abbr> of the marsh.

My doctoral thesis has focused on studying the Doñana pond network: a network of more than 3,300 water bodies ([Gómez-Rodríguez et al. 2011](https://www.researchgate.net/publication/236586598_Cartografia_de_lagunas_temporales_del_Parque_Nacional_de_Donana), [Díaz-Paniagua et al. 2015](https://www.researchgate.net/publication/305303117_El_Sistema_de_Lagunas_Temporales_de_Donana_una_red_de_habitats_acuaticos_singulares)) with such density, diversity, and connectivity that it is home to more than 600 species of animals and plants—many of them rare or threatened ([Díaz-Paniagua et al. 2015](https://www.researchgate.net/publication/305303117_El_Sistema_de_Lagunas_Temporales_de_Donana_una_red_de_habitats_acuaticos_singulares); [Green et al. 2016](https://doi.org/10.1007/978-94-007-6173-5_139-1)). These ponds lie on the aeolian mantle—the sands—and most of them are Mediterranean Temporary Ponds ([hábitat prioritario en la UE](https://eunis.eea.europa.eu/habitats/10069); [Zacharias & Zamparas 2010](https://doi.org/10.1007/s10531-010-9933-7)), with their inundation depending on the good status of the aquifer beneath them ([Custodio et al. 2009](https://www.juntadeandalucia.es/medioambiente/web/Bloques_Tematicos/agencia_andaluza_agua/participacion/publicaciones/libro_donana_baja.pdf)). However, in recent years we have witnessed—and quantified—the degradation of these aquatic ecosystems at an unprecedented pace.

<img src="{{ "/assets/img/aerealagunas.jpg" | relative_url }}" alt="Topo Doñana" style="max-width: 100%; height: auto; margin: 0 0 1rem 0;">

In 2018, 83% of the ponds were affected by groundwater abstraction for agriculture and water supply in tourist residential developments ([de Felipe et al. 2023](https://doi.org/10.1016/j.scitotenv.2023.163329)). A 59% of the ponds have disappeared completely ([de Felipe et al. 2023](https://doi.org/10.1016/j.scitotenv.2023.163329)), with their basins being colonized by terrestrial vegetation ([Díaz-Paniagua et al. 2023](https://doi.org/10.1002/aqc.3984); [Díaz-Paniagua et al. 2024](https://doi.org/10.1163/15685381-bja10179)). The disappearance of the ponds has been followed by the loss of their associated biodiversity: aquatic plants ([García-Murillo et al. 2025](https://doi.org/10.1016/j.jnc.2024.126814)), invertebrates (Florencio et al. in prep.), amphibians ([Díaz-Paniagua et al. 2024](https://doi.org/10.1163/15685381-bja10179)), and freshwater turtles (de Felipe et al. in press.). In 2024, the last permanent pond—<i>Santa Olalla</i>—[dried up for the third consecutive year]([link.al.csic](https://www.csic.es/es/actualidad-del-csic/la-laguna-de-santa-olalla-en-donana-se-seca-por-tercer-ano-consecutivo)), marking a milestone never before described in Doñana.

<img src="{{ "/assets/img/zahillo.jpeg" | relative_url }}" alt="Topo Doñana" style="max-width: 100%; height: auto; margin: 0 0 1rem 0;">

For all these reasons, it seemed essential to highlight the abundance and diversity of the Doñana ponds. However, when I tried to describe and represent them, I realized that the ponds could not be appreciated on a 10×5 cm map—the kind that typically accompanies doctoral dissertations. I then decided to represent them in A1 format: a map on which they could be seen in detail on paper for the first time and, perhaps for many of them, for the last.
