...
<figure style="margin: 0 0 1rem 0;">
  <img src="{{ "/assets/img/montes_red.jpg" | relative_url }}" alt="Topo Doñana" style="max-width: 100%; height: auto;">
  <figcaption style="font-size: 0.78em; opacity: 0.85; margin-top: 0.35rem; text-align: justify; text-justify: inter-word;">
...
<figure style="margin: 0 0 1rem 0;">
  <img src="{{ "/assets/img/coleto_red.png" | relative_url }}" alt="Topo Doñana" style="max-width: 100%; height: auto;">
  <figcaption style="font-size: 0.78em; opacity: 0.85; margin-top: 0.35rem; text-align: justify; text-justify: inter-word;">
